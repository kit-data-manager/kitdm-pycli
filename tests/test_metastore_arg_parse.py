...
def test_create_schema():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "createSchema", "-m", "metadata.json", "-pl",
            "schema.json"]
...
def test_create_document():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "createDocument", "-m", "metadata.json", "-pl",
            "document.json"]
    result = parse_arguments(args)
...
def test_get_schema():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "getSchema", "-id", "123", "456", "-v", "1"]
    result = parse_arguments(args)
...
def test_get_schema():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "getSchemas", "-f", "yesterday", "-u", "now", "-p", "1",
            "-s", "30"]
    result = parse_arguments(args)
...
def test_get_document():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "getDocument", "-id", "123", "456", "-v", "1"]
    result = parse_arguments(args)
...
def test_get_documents():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "getDocuments", "-f", "yesterday", "-u", "now", "-p", "1",
            "-s", "30"]
    result = parse_arguments(args)
...
def test_download_schema():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "downloadSchema", "-id", "123", "-v", "1"]
    result = parse_arguments(args)
...
def test_download_document():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "downloadDocument", "-id", "123", "-v", "1"]
    result = parse_arguments(args)
...
def test_update_schema():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "updateSchema", "-id", "123", "-m", "schema_record.json",
            "-pl", "schema.json"]
    result = parse_arguments(args)
...
def test_update_document():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "updateDocument", "-id", "123", "-m",
            "document_record.json", "-pl", "document.json"]
    result = parse_arguments(args)
...
def test_delete_schema():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "deleteSchema", "-id", "123", "456", "--soft"]
    result = parse_arguments(args)
...
def test_delete_document():
    ...
    args = ["-a", "-r", "LIST", "-o", "file.json", "--debug", "deleteDocument", "-id", "123", "456", "--soft"]
    result = parse_arguments(args)
