...
import sys
import runpy
from kitdm_pycli.clients.base_repo_client import main
from kitdm_pycli import __version__
...
def test_base_repo_client_create():
    ...
    response = service_client.create(None,
                                     "./tests/input/data_resource.json",
                                     None,
                                     None)
...
def test_base_repo_client_upload():
    service_client = BaseRepoClient(False)
    response = service_client.create("ff98569f-57d0-439f-90af-009cba657b0c",
                                     None,
...
def test_base_repo_client_download():
    service_client = BaseRepoClient(False)
    response = service_client.download("ff98569f-57d0-439f-90af-009cba657b0c", "file.txt", None)
